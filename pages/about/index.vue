    ...
    <div class="about-section3">
      <div class="about-me-text a-hello_container contain">
        <p class="para hero-para black70">
          I'm Raghav Aggarwal and Currently I work in 
          <a
            href="https://www.db.com/index?language_id=1"
            target="_blank"
            rel="noopener"
            title="db.com"
          >
            <span class="underline-magical">Deutsche Bank</span>
          </a> in Pune, India. Being from a non CS background, I have developed quite an interest in 
          how software industry works. May it be App development or some new technology like Blockchain, i
          am always interested to learn and dive into it. 
        </p>
